...
# 10 Reading\Writing Binary Data
...
**HW1:** Modify program bellow to have an exit option, on which it writes customers and reciepts to customers.bin and recipts.bin from the database and exits. 

**HW2:** Modify program bellow such that on starting, it should read customers and reciepts from customers.bin and recipts.bin and fill the database. It should work with the files generated in HW1.
